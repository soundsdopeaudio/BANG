...
public:
    ...
    // Convenience: mirror old names that code may still reference
    static const std::vector<Scale>& kScales() { return allScales(); }
    static const std::vector<Scale>& kAllScales() { return allScales(); }

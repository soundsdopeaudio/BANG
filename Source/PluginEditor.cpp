...
void BANGAudioProcessorEditor::openPolyrhythm()
{
    ...
    struct PolyComp : public juce::Component
    {
        ...
        void resized() override
        {
            ...
            fb.items.add(juce::FlexItem(typesBox).withFlex(1).withMaxHeight(50));
            fb.items.add(juce::FlexItem(densityLbl).withWidth(150).withHeight(50));
            fb.items.add(juce::FlexItem(densitySlider).withWidth(250).withHeight(50));
...
void BANGAudioProcessorEditor::openReharmonize()
{
    ...
    struct ReharmonizeComponent : public juce::Component
    {
        ...
        void resized() override
        {
            ...
            regenerateBtn.setBounds(row.removeFromLeft(row.getWidth() / 2).reduced(5));
        }
    };

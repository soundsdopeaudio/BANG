...
// --- CHORDS ENGINE ---
{
 ...
 break;
    ...
    case EngineSel::Melody:
    {
        auto melView = lastMelody;         // copy
        for (auto& n : melView) n.pitch = juce::jlimit(0, 127, n.pitch + audioProcessor.getOctaveShiftSemitones());
...
void BANGAudioProcessorEditor::openAdjust()
{
    struct AdjustWindow : public juce::Component
    {
        ...
        void resized() override
        {
            ...
            regenerateBtn.setBounds(buttonBounds.withSizeKeepingCentre(200, 133));
        }
    };

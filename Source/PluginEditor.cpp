    ...
    : AudioProcessorEditor(&p), audioProcessor(p)
{
    ...
    auto img = loadBinaryImage("toolTipsLbl"); { imgToolTips.setImage(img, RectanglePlacement::doNotResize); addAndMakeVisible(imgToolTips); }
    auto img = loadBinaryImage("octaveLbl"); { imgOctaveLbl.setImage(img, RectanglePlacement::doNotResize); addAndMakeVisible(imgOctaveLbl); }
    auto img = loadBinaryImage("soundsDopeLbl"); { imgSoundsDope.setImage(img, RectanglePlacement::doNotResize); addAndMakeVisible(imgSoundsDope); }
